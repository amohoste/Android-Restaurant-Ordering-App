...
import com.example.aggoetey.myapplication.Menu.dummy.DummyContent;
...
public class MenuItemListActivity extends AppCompatActivity {
    ...
    /**
     * The Menu that is currently showing
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(MenuItemDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(MenuItemDetailFragment.ARG_ITEM_ID, item.id);
